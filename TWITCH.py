...
print(df_sum)
df_sum.to_csv('/Users/Lidia/Desktop/UNI/cuarto/BIGDATA/espectadores.csv') #Exportamos el dataframe
...
categorias_vistas.to_csv(('/Users/Lidia/Desktop/UNI/cuarto/BIGDATA/Categorias_vistas.csv'), decimal=',', index=False) #exportamos
categorias_horas.to_csv(('/Users/Lidia/Desktop/UNI/cuarto/BIGDATA/espectadores_horas.csv'), decimal=',', index=False) #exportamos
...
game_counts.to_csv('/Users/Lidia/Desktop/UNI/cuarto/BIGDATA/categorias_evolucion.csv') #exportamos
...
streamers.to_csv('/Users/Lidia/Desktop/UNI/cuarto/BIGDATA/streamers.csv', decimal=',') #exportamos
...
df_std.to_csv('/Users/Lidia/Desktop/UNI/cuarto/BIGDATA/desviación.csv', decimal=',', index=False) #exportamos
